...
const procedureLinks = [
  { name: 'All Procedures & Therapies', path: '/procedures' },
  ...
  { name: 'Structured Wellness Programs', path: '/structured-wellness-programs' }
];

const singleTreatmentLinks = [
    ...
    <div className="col-lg-3 col-md-4 col-sm-6 col-xs-12 pull-left">
      ...
      <div className="single-sidebar-box">
        <div className="download-pdf text-center" style={{ background: '#131d33', padding: '30px 20px', color: '#fff', marginBottom: '30px' }}>
          ...
          <h3 style={{ color: '#fff', margin: '15px 0 10px', fontSize: '20px' }}>Clinical Brochure</h3>
          <p style={{ color: '#aaa', fontSize: '13px', marginBottom: '15px' }}>Download our complete clinical therapies menu &amp; program brochure in PDF format.</p>
      ...
      <div className="single-sidebar-box">
        <div className="quick-appointment-sidebar text-center" style={{ border: '2px solid #c59d5f', padding: '25px 20px', marginBottom: '30px' }}>
          <h3 style={{ fontSize: '20px', marginBottom: '10px' }}>Book A Consultation</h3>
          <p style={{ color: '#777', fontSize: '13px', marginBottom: '15px' }}>Call our OPD reception or schedule your appointment online.</p>
          <h4 style={{ color: '#c59d5f', fontWeight: 700, marginBottom: '15px' }}>+91 98450 12345</h4>
