...
import { structuredWellnessProgramsPageContent } from '../content/proceduresContent';

const StructuredWellnessProgramsPage = () => {
  const content = structuredWellnessProgramsPageContent;
...
export default StructuredWellnessProgramsPage;
