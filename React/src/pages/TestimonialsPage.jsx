              ...
              <div key={item.id} className="col-md-4 col-sm-6 col-xs-12">
                <div className="single-testimonial-item text-center">
                  ...
                  <div className="text-holder" style={{ borderRadius: '4px' }}>
                    <div className="rating" style={{ color: '#00B5A6', marginBottom: '12px' }}>
                    ...
                    <span className="border" style={{ display: 'block', width: '35px', height: '1.5px', background: '#00B5A6', margin: '15px auto 10px' }}></span>
